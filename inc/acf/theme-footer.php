...
acf_add_local_field_group([
    ...
    'fields' => [
        ...
        [
            ...
            'type' => 'repeater',
            'instructions' => 'Sociala medie-ikoner finns längst ner. Utelämna länktexten om du bara vill länka ikonen.',
            'layout' => 'table',
            'button_label' => 'Add Row',
            'sub_fields' => [
                [
        ...
        [
            'key' => 'field_lb_theme_footer_script',
            'label' => __('Script', 'lightning'),
            'name' => 'footer_script',
            'type' => 'textarea',
            'instructions' => __('Här kan du klistra in script som ska vara i sidfoten.', 'lightning'),
            'rows' => 12,
            'esc_html' => 1,
